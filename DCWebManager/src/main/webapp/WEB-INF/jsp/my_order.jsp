...
<body>
    ...
    function detail_user_info(){
    	...
    	*/
            	...
            	table_html += "<div class='single-table' style='width:900px;'>";
            	...
            	for (var i = 0; i < data.purchases.length; i++){
            		...
            		if(data.purchases[i].purchase_date == 0)
            			p_d = "-";
            		else{
            			p_d = convert_date(data.purchases[i].purchase_date);
            		}
            		...
            		if(data.purchases[i].canceled_date == 0)
            			cand_d = "-";
            		else{
            			cand_d = convert_date(data.purchases[i].canceled_date);
            		}
